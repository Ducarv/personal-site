    ...
    <section className="p-6 bg-[#212529] mb-6 rounded-lg shadow-lg">
      <div className="text-center items-center">
        <div className="relative mb-6 flex items-center justify-center">
          <div className="rounded-full overflow-hidden w-32 h-32 border-4 border-primary"> {/* Rounded image with border */}
        ...
        <div className="flex items-center justify-center space-x-4 mb-6"> {/* Social icons */}
          <a
